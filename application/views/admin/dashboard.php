...
<!--Navigation-->
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <ul class="nav navbar-right top-nav">
                  <li><a href="<?php echo base_url()?>admin/home/my"> Visit Site</a></li>
                <li class="dropdown">
           ...
           <!-- Sidebar Menu Items - These collapse to the responsive navigation menu on small screens -->
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    <li>
                        <a href="<?php echo base_url()?>admin/home/index"><i class="fa fa-fw fa-dashboard"></i> Dashboard</a>
                    </li>
                    <li>
                        <a href="charts.html"><i class="fa fa-fw fa-bar-chart-o"></i> Charts</a>
                    </li>
                    <li>
                        <a href="<?php echo base_url()?>admin/home/cat"><i class="fa fa-fw fa-dashboard"></i>Categories</a>
                    </li>
                    <li>
