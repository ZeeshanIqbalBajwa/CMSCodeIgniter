...
?>
    ...
    <li><a href="<?php echo base_url()?>admin/Home/index">Admin Panel</a></li>
  </ul>
</nav>
...
?>
<img  src="<?php echo base_url()?>admin/Home/my/imgs/<?php echo $photo_title ?>">
...
<div class="main">
  <div class="image1">
    <img  src="<?php echo base_url()?>public/templetes/imgs/1.jpg">
  </div>
  <div class="text1">
    <div class="container1">
    <div class="child" style="text-align: center;" >
      <img  src="<?php echo base_url()?>public/templetes/imgs/About.png">
